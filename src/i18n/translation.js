const resources = {
  en: {
    translation: {
      ...
      一鍵清空用戶資料: "Clear all settings",
      包括設定和收藏: "And collections",
      "確定清空？": "Confirm delete?",
      "確定刪除 ": "Confirm remove ",
      ...
      條款: "Terms & Conditions",
      "陳瓜 Chan Gua": "Chan Gua 陳瓜",
      應用程式: "App",
      偏好設定: "Preferences",
      分享與社群: "Share & Community",
      社群: "Community",
      能源效益: "Energy Efficiency",
      資料管理: "User Data Management",
      私隱: "Privacy",
      版本資料: "Version info",
      點擊以即時更新: "Click to update immediately",
      自定義: "Customization",
      功能與外貌: "Function & appearance",
      關閉視窗: "Close",
      功能設定: "Functionality",
      外貌設定: "Appearance",
      顯示地圖: "Map",
